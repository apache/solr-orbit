...
case ${i} in
    ...
    ;;
    # inspect command line options and skip update also if the user has specified --offline.
    #
    # Note that we do NOT consume this option as it needs to be passed to the benchmark script.
    --offline)
    SELF_UPDATE=NO
    # DO NOT CONSUME!!
    ;;
