...
from solrorbit import actor, config, exceptions, metrics, workload, client, paths, PROGRAM_NAME, telemetry
from solrorbit.worker_coordinator import runner, scheduler
...
class WorkerCoordinator:
    ...
    def _create_solr_telemetry_devices(self, clients):
        ...
        from solrorbit.client import SolrClient
