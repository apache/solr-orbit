...
| `--allow-unsupported-user-managed` | flag | off | Skip the SolrCloud-mode requirement check and run against a user-managed (non-cloud) target anyway (use very much at your own risk) |
